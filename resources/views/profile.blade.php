...
<body class="bg-[#E3F2FD]   ">
    <x-navbar></x-navbar>
    <div
        class=" font-kanit flex items-center justify-center gap-x-4  py-32 sm:py-44 bg-gradient-to-b h-full from-[#014AA6] to-[#0C81B8] relative w-full">

        <img src="{{ asset('img/Tasbeh.JPG') }}" alt="banner"
            class="w-full h-full object-cover absolute mix-blend-overlay opacity-10">
                        ...
                        <div class="bg-white w-1/2 mr-2 h-auto rounded-xl shadow-lg  p-4 flex flex-col">
                            ...
                            <div class="flex justify-between border-b border-gray-300 pb-5 ">
                                <div class="gap-4 flex flex-row ">
                                    @if ($vol->Profile)
                                        <img src="{{ asset('storage/' . $vol->Profile) }}" alt=""
                                            class="w-24 h-24 rounded-md border-gray-400 border-2">
                                    @else
                            ...
                            <div class="flex justify-start mt-auto pt-4">
                                ...
                                <label for="profile"
                                    class="inline-block uppercase text-white shadow-md cursor-pointer bg-[#1D4ED8] text-center pt-4 pb-4 pr-8 pl-8  text-xs font-medium rounded-lg">Upload
                        ...
                        <div class="bg-white w-1/2 h-auto rounded-xl shadow-lg p-4">
                            ...
                            <div class="grid grid-cols-2 gap-6 border-b border-gray-300 pb-5">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        @php
                                            ...
                                            if (isset($vol->Age)) {
                                                $year = date('Y') - $vol->Age;
                                                $approxDOB = $year . '-01-01';
                                            }
                                        @endphp
                                        <label for="age" class="block text-sm font-medium text-indigo-900">Date Of
                                            Birth</label>
                                        <input type="date" name="age" id="age" value="{{ old('age', $approxDOB) }}"
                                            class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5">
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label for="telephone"
                                            class="block text-sm font-medium text-indigo-900">Telephone
                                            Number</label>
                                        ...
                                        <div class="flex gap-6">
                                            <div class="inline-flex items-center">
                                                <input name="gender" value="MALE" type="radio"
                                                    ...
                                                    id="male"{{ $vol->Gender === 'Male' ? 'checked' : '' }}>
                                            ...
                                            <div class="inline-flex items-center">
                                                <input name="gender" value="FEMALE" type="radio"
                                                    class="peer h-5 w-5 cursor-pointer  rounded-full border border-slate-300 checked:border-slate-400 transition-all"
                                                    id="female"{{ $vol->Gender === 'Female' ? 'checked' : '' }}>
                                                <label class="relative flex items-center cursor-pointer" for="female">
                                                    <span
                                                        class="absolute bg-slate-800 w-3 h-3 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity duration-200 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></span>
                                                    <span
                                                        class="ml-2 text-slate-600 cursor-pointer text-sm">Female</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="flex justify-end pt-4">
                                ...
                                @enderror
                                {{-- <button type="submit"
                                    class="text-white bg-[#1D4ED8] hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Edit</button> --}}
                            </div>
                        </div>

                    </div>
                    <div
                        class="p-4 border mb-4 border-gray-300 bg-white rounded-xl h-auto flex justify-start items-center shadow-lg">
                        <div class="flex flex-col w-full">
                            ...
                            <div class="flex flex-row justify-around">
                                <div class="flex flex-col gap-10 mb-5 ">
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2 ">
                                        <input type="checkbox" class="peer hidden" id="Fundraising"
                                            value="Fundraising" name="skills[]"
                                            {{ in_array('Fundraising', $selectedSkills) ? 'checked' : '' }}>

                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            fill="currentColor"
                                            class="size-6 peer-checked:text-orange-600 transition-colors">
                                            <path
                                        ...
                                        <label for="Fundraising"
                                            class=" peer-checked:text-orange-600 transition-colors">Fundraising</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2 ">
                                        <input type="checkbox" class="peer hidden" id="Public"
                                            value="Public Speaking" name="skills[]"
                                        ...
                                        <label for="Public" class=" peer-checked:text-orange-600 transition-colors">
                                            Public Speaking</label>
                                    </div>
                                    <div class="flex items-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Event-Planning"
                                            value="Event Planning" name="skills[]"
                                        ...
                                        <label for="Event-Planning"
                                            class=" peer-checked:text-orange-600 transition-colors">Event
                                            Planning</label>
                                    </div>


                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Community-Outreach"
                                            value="Community Outreach" name="skills[]"
                                        ...
                                        <label for="Community-Outreach"
                                            class=" peer-checked:text-orange-600 transition-colors">Community
                                            Outreach</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Teaching-Monitorin"
                                            value="Teaching and Monitoring" name="skills[]"
                                ...
                                <div class="flex flex-col gap-10 mb-5">
                                    ...
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        ...
                                        <label for="Photography"
                                            class=" peer-checked:text-orange-600 transition-colors">Photography</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Videography"
                                            value="Videography" name="skills[]"
                                        ...
                                        <label for="Videography"
                                            class=" peer-checked:text-orange-600 transition-colors">Videography</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Graphic-Design"
                                            value="Graphic Design" name="skills[]"
                                        ...
                                        <label for="Graphic-Design"
                                            class=" peer-checked:text-orange-600 transition-colors">Graphic
                                            Design</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Medical-Healthcare"
                                            value="Medical & Healthcare" name="skills[]"
                                        ...
                                        <label for="Medical-Healthcare"
                                            class=" peer-checked:text-orange-600 transition-colors">Medical &
                                            Healthcare</label>
                                    </div>
                                ...
                                <div class="flex flex-col gap-10 mb-5">
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Animal-Care"
                                            value="Animal Care" name="skills[]"
                                        ...
                                        <label for="Animal-Care"
                                            class=" peer-checked:text-orange-600 transition-colors">Animal Care</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Report-Writing"
                                            value="Report Writing" name="skills[]"
                                        ...
                                        <label for="Report-Writing"
                                            class=" peer-checked:text-orange-600 transition-colors">Report
                                            Writing</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Content-Writing"
                                            value="Content Writing" name="skills[]"
                                        ...
                                        <label for="Content-Writing"
                                            class=" peer-checked:text-orange-600 transition-colors">Content
                                            Writing</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Marketing"
                                            value="Marketing & Branding" name="skills[]"
                                        ...
                                        <label for="Marketing"
                                            class=" peer-checked:text-orange-600 transition-colors">Marketing &
                                            Branding</label>
                                    </div>
                                    <div class="flex item-center cursor-pointer hover:text-blue-400 gap-2">
                                        <input type="checkbox" class="peer hidden" id="Media"
                                            value="Social Media Management" name="skills[]"
                                        ...
                                        <label for="Media"
                                            class=" peer-checked:text-orange-600 transition-colors">Social Media
                                            Management</label>
                                    </div>
                            ...
                            <button type="submit"
                                class="  text-white bg-[#1D4ED8]  hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
