                ...
                <div class="pt-6 px-4">
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex-shrink-0">
                                    <h3 class="text-base font-normal text-gray-500">Activity</h3>
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Total Program</span>
                                                ...
                                                <tbody class="bg-white">
                                                    <tr>
                                                        <td
                                                           ...
                                                           Application from <span class="font-semibold">Bonnie
                                                                Green</span>
                                                        </td>
                                                        <td
                                                    ...
                                                    <tr class="bg-gray-50">
                                                        <td
                                                            ...
                                                            Application to <span class="font-semibold">#00910</span>
                                                        </td>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                                            Apr 23 ,2021
                                                    ...
                                                    <tr class="bg-gray-50">
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-900 rounded-lg rounded-left">
                                                            Application <span class="font-semibold">Lana Byrd</span>
                                                        </td>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                                            Apr 15 ,2021
                                                    ...
                                                    <tr>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">
                                                            Application to <span class="font-semibold">Jese Leos</span>
                                                        </td>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                                            Apr 15 ,2021
                                                    ...
                                                    <tr class="bg-gray-50">
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-900 rounded-lg rounded-left">
                                                            Application to<span class="font-semibold">THEMESBERG
                                                                LLC</span>
                                                        </td>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                                    ...
                                                    <tr>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">
                                                            Application to<span class="font-semibold">Lana Lysle</span>
                                                        </td>
                                                        <td
                                                            class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                                            Apr 6 ,2021
                    ...
                    <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">25</span>
                                    <h3 class="text-base font-normal text-gray-500">Branch</h3>
                                </div>
                                <div
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">24</span>
                                    <h3 class="text-base font-normal text-gray-500">Upcoming Program</h3>
                                </div>
                                <div
                    ...
                    <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                        <div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-xl font-bold leading-none text-gray-900">Upcoming Program</h3>
