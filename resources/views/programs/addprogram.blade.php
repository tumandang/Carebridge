...
<body>
    ...
    <div class="flex overflow-hidden bg-white pt-16" x-data="{ isDropdownOpen1: false }">
        ...
        <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
            <main>
                <div class="bg-gray-50 shadow rounded-lg pb-0 p-2 sm:p-6 xl:p-6  2xl:col-span-2">
                    <div class="flex items-center justify-between mb-4 border-b-2 border-gray-300">
                        <div class="flex-shrink-0 mb-4 ">
                            ...
                            <span class="text-2xl font-batam sm:text-3xl leading-none font-bold text-gray-800 ">Add
                                Program</span>
